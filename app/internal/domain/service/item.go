...
func (i ItemService) Create(ctx context.Context, request CreateItemInput) (*models.Item, error) {
...
func (i ItemService) NewItemFromRequest(ctx context.Context, input CreateItemInput) (*models.Item, error) {
...
func (i ItemService) GetByID(ctx context.Context, itemID uuid.UUID) (*models.Item, error) {
	return i.repo.Get(ctx, &itemID)
}

// GetAll Получение списка запросов на платеж.
func (i ItemService) GetAll(ctx context.Context) ([]*models.Item, error) {
